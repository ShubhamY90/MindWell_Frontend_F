...
const Founders = () => {
    return (
        <div className="min-h-screen md:h-screen w-full flex flex-col items-center justify-start md:justify-center bg-[#F9FBFF] overflow-y-auto md:overflow-hidden relative py-20 md:py-0">
